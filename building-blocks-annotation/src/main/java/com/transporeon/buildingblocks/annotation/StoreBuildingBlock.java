...
@BuildingBlock(allowedAnnotations = {Entity.class, Repository.class, Cacheable.class},
		uses = InfrastructureBuildingBlock.class)
public @interface StoreBuildingBlock {
